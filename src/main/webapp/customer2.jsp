...
<script type="text/javascript">
	$(function() {
		$.ajax({
					type : "post",
					url : "/MySSH_mybatis/film/toSelectAllAddressAjax",
					dataType : "json",
...
<script type="text/javascript">
	...
	function ajaxpage(page) {
		...
		$.ajax({
					type : "post",
					url : "/MySSH_mybatis/film/toAjaxPaget",
					dataType : "json",
					data : 'page=' + page,
	...
	function deletec(id) {
		if (confirm("确定要删除吗?")) {
			$.ajax({
				type : "post",
				url : "/MySSH_mybatis/film/toDelete",
				dataType : "text",
				data : 'customer_id=' + id,
				success : function(data) {
...
<body onload="ajaxpage(pages)">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12 dhn-top">
				...
				</span></a> <a class="dhn-top-right" href="/MySSH_mybatis/film/toLogin"> <span
		...
		<div class="row dhn-content">
			<div class="col-md-2 dhn-content-left ">
				<div class="dhn-left-inner">
					...
					<form action="/MySSH_mybatis/film/toAllAddress">
						<button class="btn btn-info leftbutton  dhn-active"
							style="width: 100%;">
							...
							<div class="panel panel-default">
								<div class="panel-body">
									客户列表 <a class="btn btn-info btn-default"
										href="/MySSH_mybatis/film/toAllAddress">新增</a>
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
		...
		<form action="/MySSH_mybatis/film/toUpdate">
